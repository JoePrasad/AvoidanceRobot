// ======================================================================
// Final project.v generated from TopDesign.cysch
// 12/18/2016 at 13:42
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ea1ed440-7139-4978-a33c-2d934ee86998"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ece1ce5c-98ef-4d8b-b9be-f603fdbc36b1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("763dfa9d-6de7-4b28-aaa6-74631329cfe5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("913031d9-cccb-4068-b962-69091fafd6a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("22828b71-85e0-4373-bea0-cbe40538250b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("7156c15a-9383-416c-ad35-f66b0e06912f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("6d92c513-658a-421d-b59e-461123165a5e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("33333333333.3333"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__GPIO_PSOC1_In_net;
	wire [0:0] tmpFB_0__GPIO_PSOC1_In_net;
	wire [0:0] tmpIO_0__GPIO_PSOC1_In_net;
	electrical [0:0] tmpSIOVREF__GPIO_PSOC1_In_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_PSOC1_In
		 (.oe(tmpOE__GPIO_PSOC1_In_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_PSOC1_In_net[0:0]}),
		  .io({tmpIO_0__GPIO_PSOC1_In_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_PSOC1_In_net),
		  .interrupt({Net_1261}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPIO_PSOC1_In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_PSOC1_Out_net;
	wire [0:0] tmpFB_0__GPIO_PSOC1_Out_net;
	wire [0:0] tmpIO_0__GPIO_PSOC1_Out_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_PSOC1_Out_net;
	electrical [0:0] tmpSIOVREF__GPIO_PSOC1_Out_net;

	cy_psoc3_pins_v1_10
		#(.id("92b77c96-037a-491d-aa30-ba2fae5c6fd7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_PSOC1_Out
		 (.oe(tmpOE__GPIO_PSOC1_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_PSOC1_Out_net[0:0]}),
		  .io({tmpIO_0__GPIO_PSOC1_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_PSOC1_Out_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_PSOC1_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIO_PSOC1_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("84afbee3-5daa-4eb5-9e21-0a3c5fe82535"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
